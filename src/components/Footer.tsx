...
export function Footer() {
    return (
        ...
        <div className="flex items-center gap-3">
          <Image src="/album.jpg" width={56} height={56} alt="Capa do Álbum That's The Spirit da banda Bring Me The Horizon"/>
          <div className="flex flex-col">
            <strong className="font-normal">Follow You</strong>
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="h-1 rounded-full w-96 bg-zinc-600">
              <div className="bg-zinc-200 h-1 rounded-full w-4"></div>
            </div>
